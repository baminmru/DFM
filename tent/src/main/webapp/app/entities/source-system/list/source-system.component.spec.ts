...
import { sampleWithRequiredData } from '../source-system.test-samples';
...
describe('SourceSystem Management Component', () => {
  let comp: SourceSystemComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(SourceSystemComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sourceSystems?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to sourceSystemService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSourceSystemIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSourceSystemIdentifier).toHaveBeenCalledWith(entity);
