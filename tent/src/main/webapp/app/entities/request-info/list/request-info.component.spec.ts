...
import { sampleWithRequiredData } from '../request-info.test-samples';
import { RequestInfoService } from '../service/request-info.service';

import { RequestInfoComponent } from './request-info.component';
import SpyInstance = jest.SpyInstance;

describe('RequestInfo Management Component', () => {
  let comp: RequestInfoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(RequestInfoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.requestInfos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to requestInfoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRequestInfoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRequestInfoIdentifier).toHaveBeenCalledWith(entity);
