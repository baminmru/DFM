...
public class RequestParamDictTestSamples {
    ...
    public static RequestParamDict getRequestParamDictSample1() {
        return new RequestParamDict().id(1L).code("code1").name("name1").paramtype("paramtype1").referenceTo("referenceTo1");
    }

    public static RequestParamDict getRequestParamDictSample2() {
        return new RequestParamDict().id(2L).code("code2").name("name2").paramtype("paramtype2").referenceTo("referenceTo2");
    }
