package com.bami.ef.gateway.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.bami.ef.gateway.service.EmailAlreadyUsedException ||
            ex instanceof com.bami.ef.gateway.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.bami.ef.gateway.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.bami.ef.gateway");
    }
}
