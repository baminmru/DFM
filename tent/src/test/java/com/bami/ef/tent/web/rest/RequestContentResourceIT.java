...
import static com.bami.ef.tent.domain.RequestContentAsserts.*;
...
class RequestContentResourceIT {
    ...
    private static final Integer DEFAULT_REQUEST_INFO_ID = 1;
    private static final Integer UPDATED_REQUEST_INFO_ID = 2;
    ...
    public static RequestContent createEntity(EntityManager em) {
        RequestContent requestContent = new RequestContent()
            .requestInfoId(DEFAULT_REQUEST_INFO_ID)
    ...
    public static RequestContent createUpdatedEntity(EntityManager em) {
        RequestContent requestContent = new RequestContent()
            .requestInfoId(UPDATED_REQUEST_INFO_ID)
    ...
    @Test
    @Transactional
    void checkRequestInfoIdIsRequired() throws Exception {
    ...
    void getAllRequestContents() throws Exception {
        ...
        restRequestContentMockMvc
            ...
            .andExpect(jsonPath("$.[*].requestInfoId").value(hasItem(DEFAULT_REQUEST_INFO_ID)))
    ...
    void getRequestContent() throws Exception {
        ...
        restRequestContentMockMvc
            ...
            .andExpect(jsonPath("$.requestInfoId").value(DEFAULT_REQUEST_INFO_ID))
    ...
    void putExistingRequestContent() throws Exception {
        ...
        updatedRequestContent.requestInfoId(UPDATED_REQUEST_INFO_ID).paramCode(UPDATED_PARAM_CODE).paramValue(UPDATED_PARAM_VALUE);
    ...
    void partialUpdateRequestContentWithPatch() throws Exception {
        ...
        partialUpdatedRequestContent.requestInfoId(UPDATED_REQUEST_INFO_ID);
    ...
    void fullUpdateRequestContentWithPatch() throws Exception {
        ...
        partialUpdatedRequestContent.requestInfoId(UPDATED_REQUEST_INFO_ID).paramCode(UPDATED_PARAM_CODE).paramValue(UPDATED_PARAM_VALUE);
