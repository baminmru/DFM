...
public class RequestContentTestSamples {
    ...
    public static RequestContent getRequestContentSample1() {
        return new RequestContent().id(1L).paramCode("paramCode1").paramValue("paramValue1");
    }

    public static RequestContent getRequestContentSample2() {
        return new RequestContent().id(2L).paramCode("paramCode2").paramValue("paramValue2");
    }
