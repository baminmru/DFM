...
import { sampleWithRequiredData } from '../request-type.test-samples';
...
describe('RequestType Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to requestTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRequestTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRequestTypeIdentifier).toHaveBeenCalledWith(entity);
