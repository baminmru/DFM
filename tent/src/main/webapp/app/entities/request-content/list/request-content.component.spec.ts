...
import { sampleWithRequiredData } from '../request-content.test-samples';
...
describe('RequestContent Management Component', () => {
  let comp: RequestContentComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RequestContentComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(RequestContentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.requestContents?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to requestContentService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRequestContentIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRequestContentIdentifier).toHaveBeenCalledWith(entity);
