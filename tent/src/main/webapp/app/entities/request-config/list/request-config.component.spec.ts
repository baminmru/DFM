...
import { sampleWithRequiredData } from '../request-config.test-samples';
...
describe('RequestConfig Management Component', () => {
  let comp: RequestConfigComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RequestConfigComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(RequestConfigComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.requestConfigs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to requestConfigService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRequestConfigIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRequestConfigIdentifier).toHaveBeenCalledWith(entity);
