...
namespace dv21_load
{
	...
	public class frmCard : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.mnuImportPG = new System.Windows.Forms.MenuItem();
            ...
            this.mnuPrimeCli.Text = "PrimeNG generator";
            ...
            // mnuImportPG
            // 
            this.mnuImportPG.Index = 17;
            this.mnuImportPG.Text = "Импорт";
            this.mnuImportPG.Click += new System.EventHandler(this.mnuImportPG_Click);
            // 
            // tvStruct
            // 
            ...
            this.dlgOpen.Filter = "XML file|*.xml|JSON file|*.json|AllFiles|*.*";
		...
		private void mnuLoad_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (dlgOpen.ShowDialog() == DialogResult.OK)
				{
					...
					if(LastOpenFile.Contains(".xml"))
						cd = MyUtils.DeSerializeObject(dlgOpen.FileName);
					if (LastOpenFile.Contains(".json"))
						cd = MyUtils.DeSerializeObjectFromJSON(dlgOpen.FileName);
		...
		private void mnuSave_Click(object sender, System.EventArgs e)
		{
			...
			if (LastOpenFile != "")
			{
				try
				{
					...
					MyUtils.SerializeObjectToJSON(LastOpenFile.Replace(".xml",".json"), cd);
		...
		private void mnuTypeLib_Click(object sender, System.EventArgs e)
		{
			...
			if (MyUtils.ProjectFile.Contains(".xml"))
			{
				MyUtils.SerializeObject(MyUtils.ProjectFile, df);
				MyUtils.SerializeObjectToJSON(MyUtils.ProjectFile.Replace(".xml",".json"), df);

			}

			
			if (MyUtils.ProjectFile.Contains(".json"))
				MyUtils.SerializeObjectToJSON(MyUtils.ProjectFile, df);
        ...
        private void mnuPrimeCli_Click(object sender, EventArgs e)
        {
        ...
        private void mnuImportPG_Click(object sender, EventArgs e)
        {
