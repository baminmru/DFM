...
namespace mapper
{
    public class PGGen
    {
        ...
        public string Generate()
        {
            ...
            {
                throw new Exception("Error in Generate: " + ex.Message, ex);
            }
        }
        ...
        public string BuildMap()
        {
            ...
            {
                throw new Exception("Error in BuildMap: " + ex.Message, ex);
            }
        }
            ...
            public void BuildMapScript( string mapping)
        {
            ...
            {
                throw new Exception("Error in BuildMapScript: " + ex.Message, ex);
            }
        }
