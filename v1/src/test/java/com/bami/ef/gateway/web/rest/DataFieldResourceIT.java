...
import com.bami.ef.gateway.repository.DataFieldRepository;
...
class DataFieldResourceIT {
    ...
    void partialUpdateDataFieldWithPatch() throws Exception {
        ...
        partialUpdatedDataField.inputType(UPDATED_INPUT_TYPE).fieldType(UPDATED_FIELD_TYPE).allowNull(UPDATED_ALLOW_NULL);
