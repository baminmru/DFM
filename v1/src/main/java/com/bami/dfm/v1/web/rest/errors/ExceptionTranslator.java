package com.bami.dfm.v1.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.bami.dfm.v1.service.EmailAlreadyUsedException ||
            ex instanceof com.bami.dfm.v1.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.bami.dfm.v1.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.bami.dfm.v1");
    }
}
