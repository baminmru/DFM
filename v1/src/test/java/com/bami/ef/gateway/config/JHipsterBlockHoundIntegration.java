package com.bami.ef.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.bami.ef.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.bami.ef.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
